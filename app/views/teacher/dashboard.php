...
<div class="p-6">
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
    <a href="#" class="bg-white shadow rounded-lg p-5 hover:shadow-lg transition">Créer / Assigner Travaux</a>
    <a href="#" class="bg-white shadow rounded-lg p-5 hover:shadow-lg transition">Évaluer les Travaux</a>
