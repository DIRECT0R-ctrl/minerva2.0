...
<header class="bg-blue-600 text-white p-4 text-center shadow">
    <h1 class="text-2xl font-bold"> Minerva – Inscription Étudiante</h1>
</header>
...
<div class="flex items-center justify-center mt-16">
    <div class="bg-white shadow-lg rounded-lg p-8 w-full max-w-md">
        ...
        <form method="POST" class="space-y-5">
            ...
            <button type="submit"
                class="w-full bg-green-600 text-white py-2 rounded hover:bg-green-700 transition font-semibold">S'inscrire</button>
        </form>
