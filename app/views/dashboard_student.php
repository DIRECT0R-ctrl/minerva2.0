...
<div class="p-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
    <a href="mes_travaux.php" class="bg-white shadow rounded-lg p-5 hover:shadow-lg transition">Mes Travaux</a>
    <a href="notes.php" class="bg-white shadow rounded-lg p-5 hover:shadow-lg transition">Mes Notes</a>
